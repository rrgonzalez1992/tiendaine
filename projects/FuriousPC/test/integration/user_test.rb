...
class UserTest < ActionDispatch::IntegrationTest
  ...
  module BrowsingTestDSL
    ...
    def creates_user_account(parameters)
      ...
      assert_equal flash[:notice], "La cuenta #{user_name} fue creada con éxito. Úsala para iniciar sesión."
      assert_tag :tag => 'div', :attributes => { :id => 'notice' },
                                :content => "La cuenta #{user_name} fue creada con éxito. Úsala para iniciar sesión."
