...
class ItemTestIntegration < ActionDispatch::IntegrationTest
    ...
    private
      module ItemTestDSL
        ...
        def show_item(item)
          get "/admin/item/show?id=#{item.id}"
          assert_response :success
          assert_template "admin/item/index"
        end

        def list_items
          get "/admin/item/index"
          assert_response :success
          assert_template "admin/item/index"
        end
        ...
        def edit_item(item, parameters)
          get "/admin/item/edit?id=#{item.id}"
          assert_response :success
          assert_template "admin/item/edit"
          
          post "/admin/item/update?id=#{item.id}", parameters
          assert_response :redirect
          follow_redirect!
          assert_response :success
      ...
      def delete_item(item)
        post "/admin/item/destroy?id=#{item.id}"
        assert_response :redirect
        follow_redirect!
        assert_template "admin/item/index"
      end
